"""Base collector class for domain interrogation."""
...
class BaseCollector[T](ABC):
    """
    Base class for all domain interrogation collectors.
    ...
    def __init__(self, domain: str, timeout: float | None = None):
        """
        Initialize the collector.

        Args:
            domain: The domain to interrogate.
